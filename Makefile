...
### Common settings
# Removed NATIVE_INT64 definition
#
...
wineasio_dll_C_SRCS   = jackasio.c \
			main.c \
			register.c \
			classid.c
...
install:
	if [ -d $(PREFIX)/lib64/wine ]; then cp wineasio.dll.so $(DESTDIR)$(PREFIX)/lib64/wine; else cp wineasio.dll.so $(DESTDIR)$(PREFIX)/lib/wine; fi
